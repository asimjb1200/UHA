    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_food_purchased', models.ManyToManyField(related_name='food_used', to='inventory.food')),
                ('extra_meals_purchased', models.ManyToManyField(related_name='trip_meals', to='inventory.meal')),
                ('extra_supplies', models.ManyToManyField(related_name='trip_extras', to='inventory.supplies')),
                ('kayak_used', models.ManyToManyField(related_name='kayak', to='inventory.kayak')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True, null=True)),
                ('trailer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.trailers')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='trips',
            name='van_used',
            field=models.ManyToManyField(to='inventory.vans'),
        ),
        migrations.AddField(
            model_name='trailers',
            name='warehouse',
